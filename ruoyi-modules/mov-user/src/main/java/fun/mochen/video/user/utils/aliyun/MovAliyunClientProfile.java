package fun.mochen.video.user.utils.aliyun;
...
@Component
public class MovAliyunClientProfile extends AliyunClientProfile {
    ...
    public MovAliyunClientProfile() throws ClientException {
        super();
    }
